CREATE TABLE `hephaestus_instance` (
    ...
    `workflow_run_id` varchar(128) DEFAULT NULL COMMENT '实验实例ID',
    `instance_title` varchar(128) DEFAULT NULL COMMENT '实验名称',
    ...
    `instance_status` varchar(8) DEFAULT NULL COMMENT '实验状态 ',
    ...
    `active_stage_status` varchar(2) DEFAULT NULL COMMENT '所在节点状态',
...
CREATE TABLE `hephaestus_instance_cap` (
    ...
    `device_key` varchar(255) DEFAULT NULL COMMENT '设备key',
...
CREATE TABLE `hephaestus_instance_plate` (
     ...
     `experiment_pool_type` varchar(255) DEFAULT NULL COMMENT '实验池类型',
...
CREATE TABLE `hephaestus_instance_step` (
    ...
    `pool_type` varchar(50) DEFAULT NULL COMMENT '池类型',
    `create_time` datetime DEFAULT NULL COMMENT '创建时间',
    ...
    `step1_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step1_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step2_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step2_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step3_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step3_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step4_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step4_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step5_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step5_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step6_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step6_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step7_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step7_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step8_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step8_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step9_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step9_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step10_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step10_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step11_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step11_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step12_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step12_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step13_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step13_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step14_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step14_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step15_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step15_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step16_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step16_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step17_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step17_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step18_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step18_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step19_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step19_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step20_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step20_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step21_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step21_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step22_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step22_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step23_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step23_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step24_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step24_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step25_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step25_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step26_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step26_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step27_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step27_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step28_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step28_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step29_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step29_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step30_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step30_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step31_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step31_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
    ...
    `step32_key` varchar(50) DEFAULT NULL COMMENT '步骤类型',
    `step32_name` varchar(50) DEFAULT NULL COMMENT '步骤名称',
...
CREATE TABLE `hephaestus_instance_task` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增id',
    `device_type` varchar(255) DEFAULT '0' COMMENT '设备类型',
    `device_key` varchar(255) DEFAULT NULL COMMENT '设备key',
    `device_key_range` varchar(255) DEFAULT NULL COMMENT '可用deviceKey范围，逗号分割',
    `priority` int(11) DEFAULT '111' COMMENT '设备锁优先级 1 高  11 中 111 低',
    `device_id` varchar(255) DEFAULT NULL COMMENT '设备表device_id',
    `task_id` bigint(20) DEFAULT NULL COMMENT '任务id',
    `task_status` varchar(255) DEFAULT NULL COMMENT 'task状态 await等待，running：进行，finished：完成，failed：失败',
    `task_command` varchar(255) DEFAULT NULL COMMENT '任务命令',
    `task_parameter` varchar(2000) DEFAULT NULL COMMENT '任务参数',
    `task_name` varchar(255) DEFAULT NULL COMMENT '任务名称',
    `task_request_id` varchar(255) DEFAULT NULL COMMENT '请求id',
    `task_error_message` varchar(255) DEFAULT NULL COMMENT '异常信息',
    `instance_id` bigint(20) DEFAULT NULL COMMENT '实例id',
    `create_time` datetime DEFAULT NULL COMMENT '创建时间',
    `start_time` datetime DEFAULT NULL COMMENT '开始时间',
    ...
    `step_key` varchar(255) DEFAULT NULL COMMENT 'step key',
...
CREATE TABLE `hephaestus_instance_task_result` (
    ...
    `task_id` bigint(20) DEFAULT NULL COMMENT '任务id',
    `process_record_id` bigint(20) DEFAULT NULL COMMENT '记录id',
    `step_key` varchar(255) DEFAULT NULL COMMENT '步骤的key',
    `execution_status` varchar(255) DEFAULT NULL COMMENT '执行状态',
...
CREATE TABLE `hephaestus_resource_bottleneck` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `device_type` varchar(255) DEFAULT NULL COMMENT '设备类型',
    `pool_type` varchar(255) DEFAULT NULL COMMENT '池类型',
...
CREATE TABLE `hephaestus_resource_task` (
    ...
    `device_key` varchar(255) DEFAULT NULL COMMENT '设备key',
    `device_id` varchar(255) DEFAULT NULL COMMENT '设备表device_id',
    `step_key` varchar(255)  DEFAULT NULL COMMENT 'stepKey',
    `task_id` bigint(20) DEFAULT NULL COMMENT '任务id',
    `task_name` varchar(255) DEFAULT NULL COMMENT '任务名称',
    `task_status` varchar(255) DEFAULT NULL COMMENT 'task状态 await等待，running：进行，finished：完成，failed：失败',
    `task_command` varchar(255) DEFAULT NULL COMMENT '任务命令',
...
CREATE TABLE `hephaestus_resource_status` (
    ...
    `process_record_id` bigint(20) DEFAULT NULL COMMENT '流程记录id',
    `device_key` varchar(255) DEFAULT NULL COMMENT '设备key',
    `resource_status` varchar(50) DEFAULT NULL COMMENT '资源状态',
...
CREATE TABLE `hephaestus_resource_storage_status` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT,
    `process_record_id` bigint(20) DEFAULT NULL COMMENT '流程记录id',
    `storage_key` varchar(255) DEFAULT NULL COMMENT 'storage key',
    `device_key` varchar(255) DEFAULT NULL COMMENT '设备key',
    `instance_id` bigint(20) DEFAULT NULL COMMENT '实例id',
...
CREATE TABLE `hephaestus_instance_labware_consume` (
    ...
    `iteration_no` bigint(20) DEFAULT NULL COMMENT '通量编号',
    `instance_id` bigint(20) DEFAULT NULL COMMENT '实例id',
    `process_record_id` bigint(20) DEFAULT NULL COMMENT '流程记录id',
    `is_consumed` tinyint(4) DEFAULT '0' COMMENT '是否消费 0 未消费 1消费',
    `consume_time` datetime DEFAULT NULL COMMENT '消费时间',
...
CREATE TABLE `hephaestus_labware_transfer` (
       ...
       `transfer_type` varchar(50)  DEFAULT NULL COMMENT '移液类型 liquid, sample',
       ...
       `sample_transfer_method` varchar(60) DEFAULT NULL COMMENT 'PARTIAL（部分）、WHOLE（全部）、MIX（混合）',
       `create_by` varchar(255)  DEFAULT NULL COMMENT '创建人',
       `create_time` datetime DEFAULT NULL COMMENT '创建时间',
       `update_by` varchar(255) DEFAULT NULL COMMENT '修改人',
       `update_time` datetime DEFAULT NULL COMMENT '修改时间',
