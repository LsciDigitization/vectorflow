...
import static com.mega.component.commons.util.CollectionsUtil.selectRejected;
...
public final class FieldUtil {
     ...
     *
     * @param obj               the obj
     * @param excludeFieldNames 需要排除的field names,如果是null或者empty, 那么不会判断
     ...
     * @param excludeFieldNames 需要排除的field names,如果传递过来是null或者empty 那么不会判断
     * @return 如果 <code>obj</code> 是null,抛出 {@link NullPointerException}<br>
     * 如果 <code>excludeFieldNames</code> 是null或者empty,解析所有的field<br>
