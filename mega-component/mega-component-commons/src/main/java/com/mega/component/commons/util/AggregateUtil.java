...
import static com.mega.component.commons.bean.ConvertUtil.toBigDecimal;
import static com.mega.component.commons.lang.ObjectUtil.defaultIfNull;
import static com.mega.component.commons.util.CollectionsUtil.size;
...
public final class AggregateUtil {
     ...
     * @param scale        标度,小数的位数,四舍五入,用于 {@link BigDecimal#setScale(int, RoundingMode)}<br>
     ...
     * @param <O>           the generic type
     * @param beanIterable  bean Iterable,诸如List{@code <User>},Set{@code <User>}等
     * @param propertyNames 泛型O对象指定的属性名称,Possibly indexed and/or nested name of the property to be modified,参见
     *                      <a href="../bean/BeanUtil.html#propertyName">propertyName</a>
     * @param scale         标度,小数的位数,四舍五入,用于 {@link BigDecimal#setScale(int, RoundingMode)}<br>
     *                      如果为零或正数,则标度是小数点后的位数。<br>
     *                      如果为负数,则将该数的非标度值乘以 10 的负 scale 次幂 (通常情况用不到负数的情况)
     ...
     * @throws IllegalArgumentException 果<code>propertyNames</code> 有元素 是null <br>
     */
     ...
     * </blockquote>
     *
     * @param <O>             bean对象 或者可以被提取属性的对象
     * @param <T>             keyPropertyName对应的属性值
     * @param beanIterable    bean Iterable,诸如List{@code <User>},Set{@code <User>}等
     * @param keyPropertyName 泛型O对象指定的属性名称,Possibly indexed and/or nested name of the property to be modified,参见
     *                        <a href="../bean/BeanUtil.html#propertyName">propertyName</a>
     * @param sumPropertyName 泛型O对象指定的属性名称,Possibly indexed and/or nested name of the property to be modified,参见
     *                        <a href="../bean/BeanUtil.html#propertyName">propertyName</a>
     * @return 如果 <code>beanIterable</code> 是null或者empty,返回 {@link Collections#emptyMap()}<br>
     * 如果通过反射某个元素值是null,则使用默认值0代替,再进行累加<br>
     ...
     * @param propertyName     泛型O对象指定的属性名称,Possibly indexed and/or nested name of the property to be modified,参见
     *                         <a href="../bean/BeanUtil.html#propertyName">propertyName</a>
     * @param includePredicate 只选择 符合 <code>includePredicate</code>的对象,如果是null 则统计集合中全部的元素
     * @return 如果 <code>beanIterable</code> 是null或者empty,返回 {@link Collections#emptyMap()}<br>
     * 如果 <code>propertyName</code> 是null,抛出 {@link NullPointerException}<br>
     * 如果 <code>propertyName</code> 是blank,抛出 {@link IllegalArgumentException}<br>
     ...
     * @param propertyNames                  泛型O对象指定的属性名称,Possibly indexed and/or nested name of the property to be modified,参见
     *                                       <a href="../bean/BeanUtil.html#propertyName">propertyName</a>
     * @param propertyValueAndTransformerMap the property name value converter map
     ...
     * @param propertyNameValueConverterMap the property name value converter map
