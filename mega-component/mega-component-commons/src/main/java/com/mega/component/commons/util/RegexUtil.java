...
public final class RegexUtil {
     ...
     * </p>
     *
     * @param regexPattern 正则表达式字符串,pls use RegexPattern
     * @param input        The character sequence to be matched,support {@link String},{@link StringBuffer},{@link StringBuilder}... and so on
     ...
     * </blockquote>
     *
     * @param regexPattern 正则表达式模式,比如 (.*?)@(.*?)
     * @param input        需要被group的字符串,比如 test@163.com,support {@link String},{@link StringBuffer},{@link StringBuilder}... and so on
     * @return 如果 <code>regexPattern</code> 是null,抛出 {@link NullPointerException}<br>
     ...
     * String email = "test@163.com";
     *
     * RegexUtil.group(regexPattern, email, 1);<span style="color:green">//test</span>
     ...
     * Gets the matcher.
     *
     * @param regexPattern 正则表达式字符串,pls use {@link "RegexPattern"}
     * @param input        The character sequence to be matched,support {@link String},{@link StringBuffer},{@link StringBuilder}... and so on
     * @return 如果 <code>regexPattern</code> 是null,抛出 {@link NullPointerException}<br>
     * 如果 <code>input</code> 是null,抛出 {@link NullPointerException}<br>
