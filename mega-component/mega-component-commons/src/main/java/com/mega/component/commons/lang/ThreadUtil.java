...
import static com.mega.component.commons.bean.ConvertUtil.toLong;
...
import com.mega.component.commons.lang.thread.DefaultPartitionRunnableBuilder;
import com.mega.component.commons.lang.thread.DefaultPartitionThreadExecutor;
import com.mega.component.commons.lang.thread.PartitionEachSizeThreadConfigBuilder;
import com.mega.component.commons.lang.thread.PartitionPerHandler;
import com.mega.component.commons.lang.thread.PartitionRunnableBuilder;
import com.mega.component.commons.lang.thread.PartitionThreadConfig;
...
public final class ThreadUtil {
    ...
    /**
     * 强制当前正在执行的线程 休眠(暂停执行) <code>seconds</code> 秒.
     *
     * <p>
     ...
     *     //ThreadUtil.sleep(com.mega.component.core.TimeInterval.MILLISECOND_PER_SECONDS * 10);
     *     //简写
     ...
     *
     * @param seconds 睡眠的秒数
     * @throws IllegalArgumentException 如果 <code>seconds</code> 参数是负数
    ...
    public static final void sleepSeconds(int seconds) {
        sleep(seconds * TimeInterval.MILLISECOND_PER_SECONDS);
    }
     ...
     * </blockquote>
     *
     * @param milliseconds 睡眠的毫秒数,建议使用 {@link TimeInterval} 常量
     * @throws IllegalArgumentException 如果 <code>milliseconds</code> 参数是负数
     * @see <a href="http://localhost:9000/coding_rules#rule_key=squid%3AS2925">"Thread.sleep" should not be used in tests</a>
     * @see java.util.concurrent.TimeUnit#sleep(long) TimeUnit.SECONDS.sleep(3);
     * @see Thread#sleep(long)
     * @since 3.0.5
     ...
     *                                 必须{@code >}0
     *                                 </p>
     * @param partitionRunnableBuilder 每个线程做的事情,不能为null
     * @see com.mega.component.commons.lang.thread.DefaultPartitionThreadExecutor
     * @see com.mega.component.commons.lang.thread.DefaultPartitionThreadExecutor#INSTANCE
     * @since 1.11.0
     */
     ...
     *                              比如 100000个 User,不能为null或者empty
     *                              </p>
     * @param partitionThreadConfig the partition config
     * @param paramsMap             自定义的相关参数
     *
     *                              <p>
     *                              该参数目的是你可以在自定义的 <code>partitionRunnableBuilder</code>中使用;<br>
    ...
    /**
     * 循环 <code>threads</code> 调用 {@link Thread#start()} 再循环 <code>threads</code> 调用 {@link Thread#join()}.
     *
     * <p>
