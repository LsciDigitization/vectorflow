...
public final class ToStringConfig implements Serializable {
     ...
     *
     * <pre class="code">
     * ConvertUtil.toString(toList("test", "xinge"), DEFAULT_CONFIG) = "test,xinge";
     * ConvertUtil.toString(toList("test", "", "xinge", null), DEFAULT_CONFIG) = "test,,xinge,";
     * </pre>
     *
     * </blockquote>
     *
     ...
     *
     * <pre class="code">
     * ConvertUtil.toString(toList("test", "xinge"), IGNORE_NULL_OR_EMPTY_CONFIG) = "test,xinge";
     * ConvertUtil.toString(toList("test", "", "xinge", null), IGNORE_NULL_OR_EMPTY_CONFIG) = "test,xinge";
     * </pre>
     *
     * </blockquote>
     *
     ...
     *
     * @param connector         连接符
     * @param isJoinNullOrEmpty 是否拼接null或者empty的元素,如果是true ,表示拼接,如果是false,那么拼接的时候跳过这个元素
     * @since 1.4.0
     */
     ...
     * @param isJoinNullOrEmpty the is join null or empty
     ...
     * 是否拼接null或者empty的元素,如果是true ,表示拼接,如果是false,那么拼接的时候跳过这个元素.
     *
     * @param isJoinNullOrEmpty the isJoinNullOrEmpty to set
     * @since 1.2.1
     */
