...
import com.mega.component.commons.bean.ToStringConfig;
...
public final class TypeUtil {
     ...
     *
     * @param klass                 the klass
     * @param extractInterfaceClass 待抽取的接口类型
     * @return 如果 <code>klass</code> 是null,抛出 {@link NullPointerException}<br>
     ...
     *
     * @param klass                 the klass
     * @param extractInterfaceClass the extract interface class
    ...
    private static ParameterizedType getGenericSuperclassParameterizedType(Class<?> klass) {
        ...
        Type type = useClass.getGenericSuperclass(); //com.mega.....BaseSolrRepositoryImpl<com.mega.....SkuItem, java.lang.Long>
