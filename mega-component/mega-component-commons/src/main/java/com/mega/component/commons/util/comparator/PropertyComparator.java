...
import static com.mega.component.commons.lang.ClassUtil.isInstance;
...
public class PropertyComparator<T> implements Comparator<T>, Serializable {
     ...
     * </blockquote>
     *
     * @param propertyName 指定bean对象排序属性名字(默认正序).
     *
     *                     <p>
     *                     泛型T对象指定的属性名称,Possibly indexed and/or nested name of the property to be modified,参见
     *                     <a href="../../bean/BeanUtil.html#propertyName">propertyName</a>,<br>
     ...
     *                     如果 <code>propertyName</code> 是null,抛出 {@link NullPointerException}<br>
     *                     如果 <code>propertyName</code> 是blank,抛出 {@link IllegalArgumentException}<br>
     * @param comparator   提取 <code>propertyName</code> 的属性值之后,支持使用自定义的比较器来比较值,如果是null,那么使用默认规则
     * @since 1.5.4
     */
    @SuppressWarnings("rawtypes")
     ...
     *                                    如果 <code>propertyName</code> 是null,抛出 {@link NullPointerException}<br>
     *                                    如果 <code>propertyName</code> 是blank,抛出 {@link IllegalArgumentException}<br>
     * @param propertyValueConvertToClass 反射提取出来的值,需要类型转成到的类型
     * @since 1.5.0
     */
    @SuppressWarnings("rawtypes")
     ...
     * @param t1             the t1
     * @param t2             the t2
     * @param propertyValue1 the property value1
     * @param propertyValue2 the property value2
     * @return the int
     * @see org.apache.commons.collections4.comparators.ComparableComparator
     * @since 1.5.4
     */
