...
import static com.mega.component.commons.lang.reflect.ConstructorUtil.newInstance;
...
import com.mega.component.commons.bean.BeanUtil;
import com.mega.component.commons.bean.ConvertUtil;
import com.mega.component.commons.text.MessageFormatUtil;
import org.apache.commons.lang3.StringUtils;
import com.mega.component.commons.Validate;

/**
 * {@link ResourceBundle ResourceBundle} 工具类.
 *
 * <p>
...
public final class ResourceBundleUtil {
     ...
     *
     * <p>
     * 如果有配置文件 <b>messages\test-core-test.properties</b>,内容如下:
     * </p>
     *
     * <pre class="code">
     ...
     *
     * <pre class="code">
     * ResourceBundle resourceBundle = ResourceBundle.getBundle("messages/test-core-test");
     * ResourceBundleUtil.getValueWithArguments(resourceBundle, "test.arguments", "test", "18");
     * </pre>
     *
     * <b>返回:</b>
     *
     ...
     * @param key            Properties配置文件键名
     * @param arguments      此处可以传递Object[]数组过来
     * @return 如果配置文件中, key不存在, LOGGER.warn警告输出, 并返回 {@link StringUtils#EMPTY}<br>
     * @throws NullPointerException     如果 <code>resourceBundle</code> 或者 <code>key</code> 是null
     * @throws IllegalArgumentException 如果 <code>key</code> 是blank,抛出 {@link IllegalArgumentException}
     ...
     * <blockquote>
     * <ol>
     * <li>JDK默认使用的是{@link PropertyResourceBundle},内部是使用 hashmap来存储数据的,<br>
     ...
     * @throws NullPointerException 如果 <code>resourceBundle</code> 是null
     ...
     * @return the t
     * @throws NullPointerException 如果 <code>resourceBundle</code>或者 <code>aliasBean</code> 是null
     ...
     *
     * <p>
     * <b>场景:</b> 如项目的classpath下面有 messages/test-core-test.properties,内容如下
     * </p>
     *
     * <pre class="code">
     ...
     *
     * <pre class="code">
     * ResourceBundle resourceBundle = getResourceBundle("messages/test-core-test");
     ...
     * </blockquote>
     *
     * @param baseName 一个完全限定类名,<b>配置文件的包+类全名</b>,比如 <b>message.test-core-test</b> <span style="color:red">(不要尾缀)</span>;<br>
     *                 但是,为了和早期版本兼容,也可使用路径名来访问,比如<b>message/test-core-test</b><span style="color:red">(使用 "/")</span>
     * @return 如果资源文件 <code>baseName</code> 里面没有任何内容,返回不是null的 {@link ResourceBundle}
     * @throws NullPointerException     如果 <code>baseName</code> 是null
     * @throws IllegalArgumentException 如果 <code>baseName</code> 是 blank
     * @throws MissingResourceException 如果资源文件 <code>baseName</code> 不存在
     ...
     *
     * <p>
     * <b>场景:</b> 比如在 classpath 下面有 <b>messages\test-archetypes_en.properties</b> 和 <b>messages\test-archetypes_zh_CN.properties</b>
     * 两个配置文件,内容如下
     * </p>
     *
     * <p>
     * <b>messages\test-archetypes_en.properties</b>
     * </p>
     *
     * <pre class="code">
     * test-archetypes.welcome=欢迎(简体)
     * </pre>
     *
     * <p>
     * <b>messages\test-archetypes_zh_CN.properties</b>
     * </p>
     *
     * <pre class="code">
     * test-archetypes.welcome=欢迎(简体)
     ...
     *
     * <pre class="code">
     * ResourceBundle resourceBundle = getResourceBundle("messages/test-archetypes", Locale.ENGLISH);
     ...
     *
     * <pre class="code">
     * {"test-archetypes.welcome": "welcome(english)"}
     * </pre>
     *
     * </blockquote>
     *
     * @param baseName 一个完全限定类名,<b>配置文件的包+类全名</b>,比如 <b>message.test-core-test</b> <span style="color:red">(不要尾缀)</span>;<br>
     *                 但是,为了和早期版本兼容,也可使用路径名来访问,比如<b>message/test-core-test</b><span style="color:red">(使用 "/")</span>
     * @param locale   the locale for which a resource bundle is desired,如果是null,将使用 {@link Locale#getDefault()}
     ...
     * 否则返回 {@link PropertyResourceBundle#PropertyResourceBundle(InputStream)}
