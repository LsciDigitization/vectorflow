...
import static com.mega.component.commons.lang.ArrayUtil.EMPTY_STRING_ARRAY;
import static com.mega.component.commons.util.CollectionsUtil.newArrayList;
...
import com.mega.component.commons.CharsetType;
...
public final class StringUtil {
     ...
     * @param charsetType 字符编码,建议使用 {@link CharsetType} 定义好的常量
     ...
     *
     * @param value       字符串
     * @param charsetName 受支持的 charset 名称,比如 utf-8, {@link CharsetType}
     * @return 如果 <code>value</code> 是null,抛出 {@link NullPointerException}<br>
     ...
     * @param regex       用来匹配此字符串的正则表达式,规则参见 RegexPattern 注释
     ...
     * StringUtil.substring("jinxin.test",6)    =.test
     * </pre>
     *
     * @param text       内容 the String to get the substring from, may be null
     * @param beginIndex 从指定索引处 the position to start from,negative means count back from the end of the String by this many characters
     * @return 如果 <code>text</code> 是null,返回 null<br>
     ...
     * StringUtil.substring("jinxin.test", 6, 2)     =   .f
     * </pre>
     *
     * @param text       被截取文字
     * @param startIndex 索引开始位置,0开始
     * @param length     长度 {@code >=1}
     * @return 如果 <code>text</code> 是null,返回 null<br>
     ...
     *
     * <pre class="code">
     * StringUtil.substringLast("jinxin.test", 5) = test
     * </pre>
     *
     * </blockquote>
     *
     * @param text      文字
     * @param lastLenth 最后的位数
     * @return 如果 <code>text</code> 是null,返回 null<br>
     ...
     *
     * <p>
     * 调用了 {@link String#substring(int, int)}
     * </p>
     *
     * <h3>示例:</h3>
     *
     ...
     *
     * <pre class="code">
     * StringUtil.substringWithoutLast("jinxin.test", 5) //jinxin.fe
     * </pre>
     *
     * </blockquote>
     *
     ...
     * StringUtil.substringWithoutLast("jinxin.test", "ng")          = "jinxin.test"
     * StringUtil.substringWithoutLast("jinxin.test     ", "     ")  = "jinxin.test"
     * </pre>
     *
     * </blockquote>
     *
     ...
     *
     * @param value        value
     * @param regexSpliter 此处不是简单的分隔符,是正则表达式,<b>.$|()[{^?*+\\</b> 有特殊的含义,因此我们使用.的时候必须进行转义,<span style="color:red">"\"转义时要写成"\\\\"</span> <br>
     *                     最终调用了 {@link Pattern#split(CharSequence)}
     ...
     *
     * <pre class="code">
     * String str = "jin.xin  test ,jinxin;venusdrogon;jim ";
     * String delimiters = ";, .";
     ...
     *
     * @param str        需要被分隔的字符串
     * @param delimiters delimiter characters, assembled as String<br>
     ...
     * @param delimiters        delimiter characters, assembled as String<br>
     *                          参数中的所有字符都是分隔标记的分隔符,比如这里可以设置成 ";, " ,spring就是使用这样的字符串来分隔数组/集合的
     * @param trimTokens        是否使用 {@link String#trim()}操作token
     * @param ignoreEmptyTokens 是否忽视空白的token,如果为true,那么token必须长度 {@code >} 0;如果为false会包含长度=0 空白的字符<br>
     ...
     * StringUtil.trimAndEqualsIgnoreCase("", null)     = false
     * StringUtil.trimAndEqualsIgnoreCase("test  ", "   test")     = true
     * </pre>
     *
     * @param s1 第1个字符串
     * @param s2 第2个字符串
