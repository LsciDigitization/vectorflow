 ...
 *
 * <bean id="partitionThreadExecutor" class="com.mega.spring.scheduling.concurrent.AsyncTaskExecutorPartitionThreadExecutor">
...
public interface PartitionThreadExecutor {
     ...
     * @see com.mega.component.commons.lang.ThreadUtil#execute(List, int, Map, PartitionRunnableBuilder)
