...
import com.mega.component.commons.Alphabet;
 ...
 *
 * <ul>
 * <li>{@link Math#random()}底层也是调用的 new Random(),值＝Random nextDouble()</li>
 * <li>把 {@link Random}对象作为一个全局实例(static)来使用.Java中 {@link Random} 是线程安全的(内部进行了加锁处理);</li>
 * <li>伪随机数</li>
...
public final class RandomUtil {
     ...
     *
     * <pre class="code">
     * RandomUtil.createRandomFromString({@link com.mega.component.commons.Alphabet#DECIMAL_AND_LETTERS Alphabet.DECIMAL_AND_LETTERS}, 5)
     *
     * 从 {@link com.mega.component.commons.Alphabet#DECIMAL_AND_LETTERS  Alphabet.DECIMAL_AND_LETTERS} 随机抽取字符,组成长度是5的字符串
     * 生成的结果是可能是IFSMB
     * </pre>
     *
     * </blockquote>
     *
     * @param str    被抽取的字符串,比如{@link com.mega.component.commons.Alphabet#DECIMAL_AND_LETTERS}
    ...
    /**
     * 从{@link com.mega.component.commons.Alphabet#DECIMAL_AND_LOWERCASE_LETTERS_DISTINGUISHABLE
     ...
     * 从 {@link com.mega.component.commons.Alphabet#DECIMAL_AND_LOWERCASE_LETTERS_DISTINGUISHABLE  Alphabet.DECIMAL_AND_LOWERCASE_LETTERS_DISTINGUISHABLE} 随机抽取字符,组成长度是5的字符串
     * 生成的结果是可能是IFSMB
     * </pre>
     *
     * </blockquote>
