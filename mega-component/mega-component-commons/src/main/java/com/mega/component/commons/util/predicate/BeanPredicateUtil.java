...
import com.mega.component.commons.util.AggregateUtil;
import com.mega.component.commons.util.CollectionsUtil;
import com.mega.component.commons.util.equator.IgnoreCaseEquator;
 ...
 * @see com.mega.component.commons.util.predicate.BeanPredicate
 * @since 1.8.0
 */
...
public final class BeanPredicateUtil {
     ...
     * 如果 <code>propertyName</code> 是blank,抛出 {@link IllegalArgumentException}<br>
     * @see org.apache.commons.collections4.PredicateUtils#equalPredicate(Object)
     * @see com.mega.component.commons.util.equator.IgnoreCaseEquator#INSTANCE
     * @since 1.10.1
     */
     ...
     * @param <T>           the generic type
     * @param bean          the bean
     * @param propertyNames 如果 <code>propertyNames</code> 是null或者empty 那么取所有属性值.
     * @return 如果 <code>bean</code> 是null,返回 {@link org.apache.commons.collections4.PredicateUtils#nullPredicate()}<br>
     * 否则 调用 {@link com.mega.component.commons.bean.PropertyUtil#describe(Object, String...)} 提取属性值,再调用 {@link #equalPredicate(Map)}
     * @see #equalPredicate(String, Object)
     * @see com.mega.component.commons.bean.PropertyUtil#describe(Object, String...)
     * @since 1.10.6
     */
    ...
    public static <T, V> Predicate<T> containsPredicate(final String propertyName, final V... propertyValues) {
        ...
        return new BeanPredicate<>(
                propertyName, //
                propertyValue -> org.apache.commons.lang3.ArrayUtils.contains(propertyValues, propertyValue));

    }

    /**
     * 调用 {@link PropertyUtil#getProperty(Object, String)} 获得 <code>propertyName</code>的值,使用{@link Collection#contains(Object)
