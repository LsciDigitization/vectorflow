...
import static com.mega.component.commons.util.MapUtil.newHashMap;
 ...
 *
 *
 * <h3>{@link org.apache.commons.beanutils.PropertyUtils}与 {@link org.apache.commons.beanutils.BeanUtils}区别:</h3>
 *
 * <blockquote>
 *
 * <pre class="code">
 ...
 *
 * <p>
 * {@link org.apache.commons.beanutils.PropertyUtils}类和 {@link org.apache.commons.beanutils.BeanUtils}类很多的方法在参数上都是相同的,但返回值不同. <br>
 ...
 * </blockquote>
 *
 * @see com.mega.component.commons.bean.PropertyUtil
...
public final class BeanUtil {
     ...
     * <li>不支持<code>toObj</code>是map类型,从{@link org.apache.commons.beanutils.BeanUtilsBean#copyProperties(Object, Object)}源码可以看出,
     ...
     * </blockquote>
     *
     * <h3>注册自定义 {@link org.apache.commons.beanutils.Converter}:</h3>
     *
     * <blockquote>
     * <p>
     * 如果有
     * {@link java.util.Date}类型的需要copy,那么需要先使用{@link org.apache.commons.beanutils.ConvertUtils#register(org.apache.commons.beanutils.Converter, Class)}方法:<br>
     *
     ...
     * {@link org.apache.commons.beanutils.PropertyUtils#copyProperties(Object, Object)}区别</h3>
     *
     * <blockquote>
     * <ul>
     * <li>{@link BeanUtils#copyProperties(Object, Object)} 提供类型转换功能,即发现两个JavaBean的同名属性为不同类型时,在支持的数据类型范围内进行转换,而
     * {@link org.apache.commons.beanutils.PropertyUtils#copyProperties(Object, Object)}不支持这个功能,但是速度会更快一些.</li>
     ...
     * @param toObj                目标对象
     * @param fromObj              原始对象
     * @param includePropertyNames 包含的属性名字数组,(can be nested/indexed/mapped/combo)<br>
     *                             <ol>
     ...
     * @throws BeanOperationException 其他调用api有任何异常,转成{@link BeanOperationException}返回
     ...
     * @param propertyName Property name (can be nested/indexed/mapped/combo),参见<a href="#propertyName">propertyName</a>
     * @param value        Value to be set
     * @throws BeanOperationException 有任何异常,转成{@link BeanOperationException}返回
     ...
     * @see com.mega.component.commons.bean.PropertyUtil#setProperty(Object, String, Object)
     */
     ...
     *
     * @param bean         bean
     * @param propertyName 属性名称 (can be nested/indexed/mapped/combo),参见 <a href="#propertyName">propertyName</a>
     * @return 使用{@link BeanUtils#getProperty(Object, String)} 从对象中取得属性值
     * @throws NullPointerException     如果 <code>bean</code> 是null,或者如果 <code>propertyName</code> 是null
     * @throws IllegalArgumentException 如果 <code>propertyName</code> 是blank
     * @throws BeanOperationException   在调用 {@link BeanUtils#getProperty(Object, String)}过程中有任何异常,转成{@link BeanOperationException}返回
     ...
     * ,但是它的性能要慢很多倍</li>
     * <li>由于内部实现是通过 {@link Class#newInstance() Class.newInstance()}来构造新的对象,所以需要被clone的对象<b>必须存在默认无参构造函数</b>,否则会出现异常
     * {@link InstantiationException InstantiationException}</li>
     ...
     * @throws NullPointerException   如果 <code>bean</code> 是null
     * @throws BeanOperationException 在调用api有任何异常,转成{@link BeanOperationException}返回
     ...
     * <li>底层方法原理 {@link org.apache.commons.beanutils.BeanUtilsBean#populate(Object, Map)},循环map,调用
     * {@link org.apache.commons.beanutils.BeanUtilsBean#setProperty(Object, String, Object)}方法 ,一一对应设置到
     * <code>bean</code>对象</li>
     * <li>如果properties key中有bean中不存在的属性,那么该条数据自动忽略</li>
     * <li>如果properties key中有null,那么该条数据自动忽略,see {@link org.apache.commons.beanutils.BeanUtilsBean#populate(Object, Map)} line 817</li>
     * <li><code>bean</code>可以是Map类型,不过转换之后的key和value都会是Object类型,而不是声明的类型,see
     * {@link org.apache.commons.beanutils.BeanUtilsBean#setProperty(Object, String, Object)} line
     * 928</li>
     * </ol>
     * </blockquote>
     *
     ...
     * userName=test@xx.cn  <span style="color:green">// this is 胡编乱造的 account</span>
     * password=test  <span style="color:green">// this is 胡编乱造的 account</span>
     *
     * personal=test store
     *
     ...
     * 因为,{@link org.apache.commons.beanutils.converters.ArrayConverter} 默认允许的字符 allowedChars 只有 <code>'.', '-'</code>,其他都会被做成分隔符
     * </p>
     *
     * <p>
     * 你可以如此这般:
     ...
     * 如果properties key中有null,那么该条数据自动忽略,see {@link org.apache.commons.beanutils.BeanUtilsBean#populate(Object, Map)} line 817<br>
     * @throws NullPointerException   如果 <code>bean</code> 是null,或者如果 <code>properties</code> 是null
     * @throws BeanOperationException 在调用{@link BeanUtils#populate(Object, Map)}过程中有任何异常,转成{@link BeanOperationException}返回
     ...
     *
     * @param <T>              the generic type
     * @param aliasBean        the bean
     * @param aliasAndValueMap the key and value map
     ...
     * @throws NullPointerException 如果 <code>klass</code> 是null
     * @since 1.8.1
     */
     ...
     * @throws NullPointerException     如果 <code>valueMap</code> 是null,或者 <code>valueMap</code>中有key是null
     * @throws IllegalArgumentException 如果<code>valueMap</code>中有key是empty
