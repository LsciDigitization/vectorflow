...
import com.mega.component.commons.bean.BeanOperationException;
...
public final class EnumUtil {
     ...
     * @param enumClass      枚举类 比如 <code>HttpMethodType</code>
     * @param propertyName   字段名称,比如 <code>HttpMethodType</code> 的method,按照javabean 规范
     * @param specifiedValue 属性值 比如post
     * @return 如果遍历所有枚举值, 找不到枚举值的属性<code>propertyName</code>的值是 <code>specifiedValue</code>,那么返回null
     * @throws NullPointerException     如果 <code>enumClass</code> 是null,或者 <code>propertyName</code> 是null
     * @throws IllegalArgumentException 如果 <code>propertyName</code> 是blank
     * @throws BeanOperationException   如果枚举值没有相关 <code>propertyName</code> 属性,比如 <code>HttpMethodType</code> 有 <b>"method"</b> 属性,但是没有 <b>"method2222"</b> 属性
