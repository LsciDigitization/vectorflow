...
import static com.mega.component.commons.util.comparator.SortHelper.isAsc;
...
public final class BeanComparatorUtil {
     ...
     * @throws NullPointerException     如果 <code>propertyNameAndOrders</code> 是null,<br>
     *                                  或者有元素是 null;
     * @throws IllegalArgumentException 如果 <code>propertyNameAndOrders</code> 是empty,<br>
     *                                  或者有元素是 blank
    ...
    public static <T> Comparator<T> chainedComparator(String... propertyNameAndOrders) {
        ...
        //如果propertyNameAndOrders是单值,那么直接调用 com.mega.component.core.util.comparator.BeanComparatorUtil.propertyComparator(String) 返回
     ...
     *
     * @param <T>                  the generic type
     * @param propertyNameAndOrder 属性名称和排序因子,
     *
     *                             <p>
     *                             格式可以是纯的属性名称, 比如 "name"; 也可以是属性名称+排序因子(以空格分隔),比如 "name desc"
     *                             </p>
     ...
     * @throws NullPointerException     如果 <code>propertyNameAndOrder</code> 是null
     * @throws IllegalArgumentException 如果 <code>propertyNameAndOrder</code> 是blank
