package com.mega.component.commons.date;

import static com.mega.component.commons.TimeInterval.MILLISECOND_PER_DAY;
import static com.mega.component.commons.TimeInterval.MILLISECOND_PER_HOUR;
import static com.mega.component.commons.TimeInterval.MILLISECOND_PER_MINUTE;
import static com.mega.component.commons.TimeInterval.MILLISECOND_PER_MONTH;
import static com.mega.component.commons.TimeInterval.MILLISECOND_PER_SECONDS;
import static com.mega.component.commons.TimeInterval.MILLISECOND_PER_WEEK;
import static com.mega.component.commons.TimeInterval.SECONDS_PER_HOUR;
import static com.mega.component.commons.TimeInterval.SECONDS_PER_MINUTE;
import static com.mega.component.commons.Validator.isNullOrEmpty;
import static com.mega.component.commons.date.CalendarUtil.resetDayBegin;
import static com.mega.component.commons.date.CalendarUtil.resetDayEnd;
import static com.mega.component.commons.date.CalendarUtil.resetYearEnd;
import static com.mega.component.commons.util.ResourceBundleUtil.getResourceBundle;
import static com.mega.component.commons.util.ResourceBundleUtil.toMap;
...
import com.mega.component.commons.TimeInterval;
...
public final class DateUtil {
     ...
     * @since 3.0.0
     */
    private static final Map<String, String> UNIT_CONFIG_MAP = toMap(getResourceBundle("config/dateutil"));
     ...
     * @return 如果 <code>date</code>是null,抛出 {@link IllegalArgumentException}<br>
     * 如果 <code>year==0</code>,那么什么都不做,返回 <code>date</code>,参见 {@link GregorianCalendar#add(int, int)}
     * @throws NullPointerException 如果 <code>date</code> 是<code>null</code>
     * @see Calendar#YEAR
     ...
     *
     * @param date            the date
     * @param beginDateString the begin date string
     ...
     * <li>在 {@link GregorianCalendar#gregorianCutoverYearJulian 1582}年之前是四年一闰,
     * {@link GregorianCalendar#gregorianCutoverYearJulian 1582}年之后 四年一闰,百年不闰,四百年再闰</li>
     * </ol>
     * </blockquote>
     *
     * @param year 年份
     ...
     * </blockquote>
     *
     * @param spaceMilliseconds 总共相差的毫秒数
     ...
     * 获得相差的月数.
     *
     * @param spaceTime the space time
     * @return the interval week
     * @see com.mega.component.commons.TimeInterval#MILLISECOND_PER_MONTH
     * @since 3.1.1
     */
     ...
     * @param spaceTime the space time
     * @return the interval week
     * @see com.mega.component.commons.TimeInterval#SECONDS_PER_WEEK
     * @since 1.6.0
     * @since 3.0.0 move from DateExtensionUtil
     */
