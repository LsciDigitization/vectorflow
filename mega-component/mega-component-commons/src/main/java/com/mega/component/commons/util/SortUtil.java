...
import com.mega.component.commons.util.comparator.BeanComparatorUtil;
import com.mega.component.commons.util.comparator.ComparatorUtil;
import com.mega.component.commons.util.comparator.PropertyComparator;
...
public final class SortUtil {
     ...
     * <blockquote>
     * <ol>
     * <li>{@link Collections#sort(List) Collections.sort} 底层就是调用的是 {@link Arrays#sort(Object[]) Arrays.sort}</li>
     * </ol>
     * </blockquote>
     *
     * <h3>示例:</h3>
     ...
     * <blockquote>
     * <ol>
     * <li>默认使用的是 {@link FixedOrderComparator.UnknownObjectBehavior#AFTER} ,不在指定固定顺序的元素将排在后面</li>
     * </ol>
     * </blockquote>
     *
     * <h3>示例:</h3>
     ...
     *
     * <pre class="code">
     * com.mega.component.core.util.SortUtil.sortListByFixedOrderArray(
     *                 list,
     *                 StoPropertyConstants.PRPT_ITEM_HYPELAUNCH,
     *                 StoPropertyConstants.PRPT_ITEM_PRESONALLZATION_CODE,
     *                 StoPropertyConstants.PRPT_ITEM_PERSALES_CODE,
     ...
     * @param <T>             the generic type
     * @param list            the list
     * @param fixedOrderItems the fixed order items
     * @return 如果 <code>list</code> 是null,返回 {@link Collections#emptyList()}<br>
     ...
     *
     * <pre class="code">
     * com.mega.component.core.util.SortUtil.sortListByFixedOrderList(
     *                 list,
     *                 toList(
     *                                 StoPropertyConstants.PRPT_ITEM_HYPELAUNCH,
     *                                 StoPropertyConstants.PRPT_ITEM_PRESONALLZATION_CODE,
     ...
     * @param <T>                the generic type
     * @param list               the list
     * @param fixedOrderItemList the fixed order item list
     * @return 如果 <code>list</code> 是null,返回 {@link Collections#emptyList()}<br>
     * 如果 <code>list</code> 是empty,返回 <code>list</code><br>
     * 如果 <code>fixedOrderItemList</code> 是null或者是 empty,返回 <code>list</code><br>
     * @see Collections#sort(List)
     * @see com.mega.component.commons.util.comparator.ComparatorUtil#buildFixedOrderComparator(List)
     * @since 1.14.3
     */
     ...
     * @param <O>                   the generic type
     * @param list                  the list
     * @param propertyNameAndOrders 属性名称和排序因子,
     *
     *                              <p>
     ...
     *                              </blockquote>
     * @return 如果 <code>list</code> 是null,返回 {@link Collections#emptyList()}<br>
     * @throws NullPointerException     如果 <code>propertyNames</code> 是null
     * @throws IllegalArgumentException 如果 <code>propertyNames</code> 是empty ,或者有 null元素
     * @see BeanComparatorUtil#chainedComparator(String...)
     * @see ComparatorUtils#chainedComparator(Comparator...)
     ...
     * @return 如果 <code>list</code> 是null,返回 {@link Collections#emptyList()}<br>
     * @throws NullPointerException     如果 <code>propertyName</code> 是null,或者 <code>propertyValues</code> 是null
    ...
    /**
     * 使用 基于 {@link Map.Entry Entry} 的 <code>mapEntryComparator</code> 来对 <code>map</code>进行排序.
     *
     * <h3>说明:</h3>
     * <blockquote>
     * <ol>
     * <li><span style="color:red">原 <code>map</code> 的顺序不变</span></li>
     * <li>由于是对{@link Map.Entry Entry}排序的, 既可以按照key来排序,也可以按照value来排序哦</li>
     * </ol>
     * </blockquote>
     *
     * <h3>示例:</h3>
     ...
     * @param <V>                the value type
     * @param map                the map
     * @param mapEntryComparator 基于 {@link Map.Entry Entry} 的 {@link Comparator}
     * @return 如果 <code>map</code> 是null,返回 {@link Collections#emptyMap()}<br>
