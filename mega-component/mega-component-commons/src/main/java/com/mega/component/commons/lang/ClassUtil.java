...
import com.mega.component.commons.lang.reflect.ReflectException;
 ...
 * {@link Class} 工具类.
 *
 * <h3>关于 Class {@link Class#getCanonicalName() getCanonicalName()} VS {@link Class#getName() getName()} VS
 * {@link Class#getSimpleName() getSimpleName()}</h3>
 *
 * <blockquote>
 * <p>
 * 假设class 是 {@link com.mega.component.commons.DatePattern}
 * </p>
 *
 ...
 *
 * <tr valign="top">
 * <td>{@link Class#getCanonicalName() getCanonicalName()}</td>
 * <td>返回 <b>Java Language Specification</b> 中所定义的底层类的规范化名称。<br>
 * 如果底层类没有规范化名称（即如果底层类是一个组件类型没有规范化名称的本地类、匿名类或数组）,则返回 null。</td>
 * <td>"com.mega.component.core.date.DatePattern"</td>
 * </tr>
 *
 * <tr valign="top" style="background-color:#eeeeff">
 * <td>{@link Class#getName() getName()}</td>
 ...
 *
 * <tr valign="top">
 * <td>{@link Class#getSimpleName() getSimpleName()}</td>
 * <td>
 ...
 *
 * <p>
 * {@link Class#getCanonicalName() getCanonicalName()} 和 {@link Class#getName() getName()} 其实这两个方法,对于大部分class来说,没有什么不同的
 * <br>
 * 但是对于array就显示出来了.
 * </p>
 *
 * <ul>
 * <li>{@link Class#getName() getName()} 返回的是<b>[[Ljava.lang.String</b>之类的表现形式,</li>
 * <li>而 {@link Class#getCanonicalName() getCanonicalName()} 返回的就是跟我们声明类似的形式.</li>
 * </ul>
 *
 * </blockquote>
 *
...
public final class ClassUtil {
     ...
     *
     * <tr valign="top">
     * <td><code>Class klass=对象引用o.{@link Object#getClass() getClass()};</code></td>
     ...
     *
     * <tr valign="top">
     * <td><code>Class klass={@link Class#forName(String) Class.forName}("类全名");</code></td>
     * <td>装载连接<b>初始化类</b>.</td>
     * </tr>
     *
     * <tr valign="top" style="background-color:#eeeeff">
     * <td><code>Class klass={@link ClassLoader#loadClass(String) ClassLoader.loadClass}("类全名");</code></td>
     * <td>装载类,不连接不初始化.</td>
     * </tr>
     *
     * </table>
     * </blockquote>
     *
     * @param className 包名+类名,比如 "com.mega.component.core.Validate"
