...
import com.mega.component.commons.URIComponents;
import com.mega.component.commons.lang.StringUtil;
import org.apache.commons.lang3.StringUtils;
import com.mega.component.commons.Validate;

/**
 * 处理{@link URI}(Uniform Resource Locator) {@link URL}(Uniform Resource Identifier) 等.
 *
 * <h3>{@link URI}和 {@link URL}的区别:</h3>
 *
 * <blockquote>
 *
 ...
 *
 * <p>
 * 也就是说,{@link URI URI}是以一种抽象的,高层次概念定义统一资源标识,而URL和URN则是具体的资源标识的方式.URL和URN都是一种URI.
 * </p>
 *
 * <p>
...
public final class URIUtil {
    ...
    /**
     * 直接调用 {@link URI#create(String)} 创造一个URI,异常信息更丰富.
     *
     ...
     * 如果知道URI是有效的,不会产生 {@link URISyntaxException},可以使用静态的 {@link URI#create(String)}方法
     * </p>
     * </blockquote>
     *
     * @param uri the uri
     ...
     * @throws URIParseException 如果转换的时候有任何异常
     * @see URI#URI(String)
     * @since 1.8.0
     */
     ...
     * @param charsetType 字符编码,建议使用 {@link CharsetType} 定义好的常量,如果是null或者 empty,那么参数部分原样返回,自己去处理兼容性问题<br>
     ...
     * </li>
     *
     * <li>不要用 {@link URLEncoder} 或者 {@link URLDecoder}来处理整个URL,一般用来处理参数值.</li>
     ...
     * @param value          the value
     * @param charsetType    字符编码,建议使用 {@link CharsetType} 定义好的常量
     * @param encodeOrDecode true 为encode,false为 decode
     * @return 如果 <code>value</code> 是null或者empty,返回 {@link StringUtils#EMPTY}<br>
     * 如果 <code>charsetType</code> 是null或者empty,返回 <code>value</code><br>
     * @since 1.6.2
     */
