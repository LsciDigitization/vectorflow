 ...
 * </blockquote>
 *
 * <h3>{@link PropertyUtils}与 {@link org.apache.commons.beanutils.BeanUtils}:</h3>
 *
 * <blockquote>
 * <p>
 * {@link PropertyUtils}类和{@link org.apache.commons.beanutils.BeanUtils}类很多的方法在参数上都是相同的,但返回值不同.<br>
 * {@link org.apache.commons.beanutils.BeanUtils}着重于"Bean",返回值通常是{@link String},<br>
 * 而{@link PropertyUtils}着重于属性,它的返回值通常是{@link Object}. 
 * </p>
 * </blockquote>
 *
 * @see org.apache.commons.beanutils.PropertyUtils
 * @see com.mega.component.commons.bean.BeanUtil
 * @since 1.0.0
 */
public final class PropertyUtil {
     ...
     * oldUser.setDate(now());
     * oldUser.setNickName(ConvertUtil.toArray("test", "飞天奔月", "venusdrogon"));
     *
     ...
     * </blockquote>
     *
     * <h3>{@link org.apache.commons.beanutils.BeanUtils#copyProperties(Object, Object)}与
     * {@link PropertyUtils#copyProperties(Object, Object)}区别</h3>
     *
     * <blockquote>
     * <ul>
     * <li>{@link org.apache.commons.beanutils.BeanUtils#copyProperties(Object, Object) BeanUtils}
     ...
     * @throws BeanOperationException 如果在copy的过程中,有任何的checkedException,将会被转成该异常返回
     ...
     * <blockquote>
     * <ol>
     * <li>取到bean class的 {@link PropertyDescriptor}数组</li>
     * <li>循环,找到 {@link PropertyDescriptor#getReadMethod()}</li>
     ...
     * <pre class="code">
     * User newUser = new User();
     * PropertyUtil.setProperty(newUser, "name", "test");
     ...
     * {@link org.apache.commons.beanutils.PropertyUtilsBean#setSimpleProperty(Object, String, Object) setSimpleProperty} Line2078,转成
     ...
     * <li>如果 <code>propertyName</code> 是blank,抛出 {@link IllegalArgumentException}</li>
     * <li>如果<code>bean</code>没有传入的 <code>propertyName</code>属性名字,会抛出异常,see
     * {@link org.apache.commons.beanutils.PropertyUtilsBean#setSimpleProperty(Object, String, Object)} Line2078</li>
     * <li>对于Date类型,<span style="color:red">不需要先注册converter</span></li>
     * </ol>
     * </blockquote>
     *
