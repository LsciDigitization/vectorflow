...
public final class ArrayUtil {
     ...
     *
     * <pre class="code">
     * ArrayUtil.getElement(new String[] { "jinxin", "test", "1" }, 2)   =   1
     ...
     * @throws NullPointerException     如果 <code>array</code> 是null
     * @throws IllegalArgumentException 如果 <code>array</code> 不是数组
