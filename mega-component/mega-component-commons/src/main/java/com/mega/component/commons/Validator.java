 ...
 * <li><code>数组</code>{@link Class#isArray()},判断 {@link Array#getLength(Object)} ==0</li>
 * </ol>
 * </blockquote>
 *
 * @see String#trim()
...
public final class Validator {
     ...
     * </blockquote>
     *
     * @param values 元素可以是{@link Collection},{@link Map},{@link Enumeration},{@link Iterator},{@link Iterable},{@link CharSequence},
     *               以及所有数组类型(包括原始类型数组)
     * @return 如果values是null, 返回false<br>
     * 如果values是empty也返回false<br>
     * 逻辑和 StringUtils#isAnyBlank(CharSequence...) 保持一致
     * 其他情况返回false<br>
     * @see org.apache.commons.lang3.StringUtils#isAnyBlank(CharSequence...)
     * @since 3.2.0
     */
