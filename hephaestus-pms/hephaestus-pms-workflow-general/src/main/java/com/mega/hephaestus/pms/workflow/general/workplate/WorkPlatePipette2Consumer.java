...
//@Component
@Slf4j
public class WorkPlatePipette2Consumer implements WorkPlateConsumer<InstanceLabwareModel>, WorkPlateRegister {

    private static final PlateType plateType = GeneralPlateTypeEnum.PIPETTE2;

    private InstanceLabwareManager instanceLabwareManager;

    public WorkPlatePipette2Consumer() {
    }

    public WorkPlatePipette2Consumer(InstanceLabwareManager instanceLabwareManager) {
