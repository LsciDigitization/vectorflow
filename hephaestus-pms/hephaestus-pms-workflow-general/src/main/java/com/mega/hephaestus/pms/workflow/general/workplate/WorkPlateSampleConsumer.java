...
//@Component
@Slf4j
public class WorkPlateSampleConsumer implements WorkPlateConsumer<InstanceLabwareModel>, WorkPlateRegister {

    private static final PlateType plateType = GeneralPlateTypeEnum.SAMPLE;

    private InstanceLabwareManager instanceLabwareManager;

    public WorkPlateSampleConsumer() {
    }

    public WorkPlateSampleConsumer(InstanceLabwareManager instanceLabwareManager) {
