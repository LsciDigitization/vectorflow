...
//@Component
@Slf4j
public class WorkPlateEmptyConsumer implements WorkPlateConsumer<InstanceLabwareModel>, WorkPlateRegister {

    private static final PlateType plateType = GeneralPlateTypeEnum.EMPTY;

    private InstanceLabwareManager instanceLabwareManager;

    public WorkPlateEmptyConsumer() {
    }

    public WorkPlateEmptyConsumer(InstanceLabwareManager instanceLabwareManager) {
