...
//@Component
@Slf4j
public class WorkPlateStandardConsumer implements WorkPlateConsumer<InstanceLabwareModel>, WorkPlateRegister {

    private static final PlateType plateType = GeneralPlateTypeEnum.STANDARD;

    private InstanceLabwareManager instanceLabwareManager;

    public WorkPlateStandardConsumer() {
    }

    public WorkPlateStandardConsumer(InstanceLabwareManager instanceLabwareManager) {
